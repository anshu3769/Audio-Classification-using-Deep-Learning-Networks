...
parser = argparse.ArgumentParser(description='Make Train/Test/Validation data for speech commands dataset.')
parser.add_argument('original_fold', help='the path to the root folder of the speech commands dataset.')
parser.add_argument('--out_path', default='gcommands', help='the path to save the files for project data.')

if __name__ == '__main__':
    args = parser.parse_args()
    make_dataset(args.original_fold, args.out_path)
